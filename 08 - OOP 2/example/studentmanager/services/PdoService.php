...
class PdoService
{
     ...
     * @param array $where the parameters for the where clause.
     * @param string $className the class name to fetch the records as.
     * @return array The fetched records as object of the specified class.
     */
